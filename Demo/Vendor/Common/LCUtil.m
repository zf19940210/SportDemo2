...
+(NSString *)getImagePath:(UIImage *)Image {
    ...
    NSString *ImagePath = [[NSString alloc] initWithFormat:@"%@",fileName];
...
//年月日
+(NSString *)getYearAndMouthAndDay
{
    NSDate *date = [NSDate date];
    NSCalendar *canlendaer = [[NSCalendar alloc]initWithCalendarIdentifier:NSCalendarIdentifierGregorian];
    NSDateComponents *comps = [[NSDateComponents alloc]init];
    NSInteger unitFlags = NSCalendarUnitYear |  NSCalendarUnitMonth | NSCalendarUnitDay | NSCalendarUnitWeekday | NSCalendarUnitHour | NSCalendarUnitMinute | NSCalendarUnitSecond;
    comps = [canlendaer components:unitFlags fromDate:date];
    int week = [comps weekday];
    int year = [comps year];
    int month = [comps month];
    int day  = [comps day];
    NSString *allStr = [NSString stringWithFormat:@"%d-%02d-%02d",year,month,day];
    return allStr;
}
//星期几
+(NSString *)getWeek
{
    NSArray *allWeek = [NSArray arrayWithObjects:@"星期日",@"星期一",@"星期二",@"星期三",@"星期四",@"星期五",@"星期六", nil];
    NSDate *date = [NSDate date];
    NSCalendar *canlendaer = [[NSCalendar alloc]initWithCalendarIdentifier:NSCalendarIdentifierGregorian];
    NSDateComponents *comps = [[NSDateComponents alloc]init];
    NSInteger unitFlags = NSCalendarUnitYear |  NSCalendarUnitMonth | NSCalendarUnitDay | NSCalendarUnitWeekday | NSCalendarUnitHour | NSCalendarUnitMinute | NSCalendarUnitSecond;
    ...
    int month = [comps month];
    int day  = [comps day];
    NSString *weekstr = [allWeek objectAtIndex:week-1];
    return weekstr;
}
@end
